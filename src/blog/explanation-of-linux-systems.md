...
| CentOS Stream            | RHELのアップストリーム開発ブランチで、RHELの次期マイナーリリースに<br/>何が含まれるかを事前に確認できるローリングプレビューのような性質を持っている |
...
|ランク| 名称             | 系統    | 備考                           |
| ---: | ------------------ | :-----: | ------------------------------ |
| 1   | [EndeavourOS](https://endeavouros.com/)   | Arch系 | 管理人が使用しているため。+Gnome+ChaoticAUR使用 |
