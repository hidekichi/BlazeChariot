...
export async function topCoverSlideImage() {
  ...
  function checkboxText() {
    const checkboxSpan = document.querySelector(".checkbox .spanContainer span");
    if (checkboxSpan) {
  ...
  // 画像設定
  await setBackgroundImage(".cover", "/static/images/covertreasure.avif", "/static/images/covertreasure.webp");
